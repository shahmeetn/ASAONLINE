   ...
   <div class="wrapper">
      ...
      <section>
         ...
         <div class="main-content">
            <h3>Vehical Category
               <br>
<!--                <small>Add categories for vehicle selection.</small> -->
            </h3>
            <!-- START row-->
                  ...
                  <form method="post" action="<%=request.getContextPath()%>/VehicleCategoryController" class="form-horizontal">
                     ...
                     <fieldset>
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">
                              <textarea name="categoryDescription"  placeholder="Category Description" class="form-control"></textarea>
                           </div>
                        </div>
                     </fieldset>
                        ...
                        <div class="form-group">
                           <div class="col-sm-6 col-sm-offset-3">
                              <input  type="submit" class="btn btn-primary" value="Add"/>
                           	  <input type="hidden" name="flag" value="insertVehicleCategory">
